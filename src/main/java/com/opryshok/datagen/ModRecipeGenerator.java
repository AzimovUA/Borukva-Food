...
public class ModRecipeGenerator extends RecipeGenerator {
    ...
    public void generate() {
        ...
        createShaped(RecipeCategory.BREWING, ModItems.EMPTY_JAR, 1)
            ...
            .pattern("G G")
            .pattern(" G ")
            .input('S', TagKey.of(RegistryKeys.ITEM, Identifier.of("minecraft", "wooden_slabs")))
        ...
        of(exporter,
            ...
            PotRecipe.of("rotten_soup", List.of(
                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ModTags.Items.ROTTEN_SOUP_INGREDIENTS)),
                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ModTags.Items.ROTTEN_SOUP_INGREDIENTS)),
                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ModTags.Items.ROTTEN_SOUP_INGREDIENTS)),
                CountedIngredient.fromTag(1, itemLookup.getOrThrow(ModTags.Items.ROTTEN_SOUP_INGREDIENTS))
